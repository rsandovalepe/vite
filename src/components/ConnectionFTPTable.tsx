...
interface ConnectionFTPTableProps {
  selectedIds?: number[]
  onSelectedIdsChange?: (ids: number[]) => void
  connections?: ConnectionFTP[]
  readOnly?: boolean
}

function ConnectionFTPTable({
  selectedIds = [],
  onSelectedIdsChange,
  connections: initialConnections,
  readOnly,
}: ConnectionFTPTableProps) {
  const [connections, setConnections] = useState<ConnectionFTP[]>(initialConnections || [])
  ...
  return (
    <div>
      <h3 className="text-lg">Connection FTP</h3>
      <Table>
        <TableHeader>
          <TableRow>
            {!readOnly && (
...
export default ConnectionFTPTable
